...
local acct_port, acct_secret, acct_server, anonymous_identity, ant1, ant2,
	...
	wmm, wpakey, wps, disassoc_low_ack, short_preamble, beacon_int
...
if hwtype == "mac80211" then
	...
	s:taboption("advanced", Flag, "noscan", translate("Force 40MHz mode"),translate("Always use 40MHz channels even if the secondary channel overlaps.\
				Using this option does not comply with IEEE 802.11n-2009!")).optional = true
