...
f = SimpleForm("mounts", translate("Mounts"), translate("This gives an overview of mounted filesystems and if the block-mount package is installed allows to generate a filesystem configuration file (fstab)."))
f.reset = false
f.submit = false
...
v = f:section(Table, non_system_mounts, translate("Mounted file systems"))

fso = v:option(DummyValue, "fs", translate("Filesystem"))
