...
if hwtype == "mac80211" or hwtype == "prism2" then
	...
	if hostapd and supplicant then
		...
		encr:value("authsae", "SAE", {mode="mesh"})
...
authsae = s:taboption("encryption", Value, "_sae_key", translate("Key"))
authsae:depends("encryption", "authsae")
authsae.rmempty = true
authsae.datatype = "wpakey"
authsae.password = true

authsae.cfgvalue = function(self, section, value)
	local key = m.uci:get("wireless", section, "key")
	return key
end

authsae.write = function(self, section, value)
	self.map.uci:set("wireless", section, "key", value)
end
