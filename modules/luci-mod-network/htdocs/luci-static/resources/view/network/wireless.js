...
function render_signal_badge(signalPercent, signalValue, noiseValue, wrap, mode) {
	...
	case(signalPercent == 0): icon = L.resource('icons/signal-00.svg');		break;
	case(signalPercent < 25): icon = L.resource('icons/signal-00-25.svg'); 	break;
	case(signalPercent < 50): icon = L.resource('icons/signal-25-50.svg');	break;
	case(signalPercent < 75): icon = L.resource('icons/signal-50-75.svg');	break;
	}
