...
return view.extend({
	...
	render: function(hosts_duids_pools) {
		...
		o = s.taboption('hosts', form.SectionValue, '__hosts__', form.GridSection, 'domain', null,
			_('Hostnames are used to bind a domain name to an IP address. This setting is redundant for hostnames adready configured with static leases, but it can be useful to rebind an FQDN.'));
