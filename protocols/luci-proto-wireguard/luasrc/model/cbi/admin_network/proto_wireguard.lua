...
local private_key, listen_port, addresses
...
addresses = section:taboption(
  ...
  translate("Required. IP adress(es) of the tunnel interface in prefix " ..
            "notation.")
)
addresses.datatype = "or(ip6addr, ip4addr)"
addresses.placeholder = "fd00:13:37::1/64"
addresses.optional = false
...
peers = map:section(
  TypedSection,
  "wireguard_" .. string.sub(ifname, 4),
  translate("Peers"),
...
route_allowed_ips.enabled = "enabled"
route_allowed_ips.disabled = "disabled"
