	...
	renderFormOptions: function(s) {
		...
		o.handleGenerateQR = function(section_id, ev) {
			...
			return Promise.all([
				...
				qro = qrs.option(form.DynamicList, 'allowed_ips', _('Allowed IPs'), _('IP addresses that are allowed inside the tunnel. The peer will accept from the tunnel the packets whose source IP address matches this list, and route to the tunnel the packets whose destination IP address matches this list.'));
				qro.datatype = 'ipaddr';
				qro.default = ips;
