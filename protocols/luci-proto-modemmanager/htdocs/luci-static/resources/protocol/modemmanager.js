...
return network.registerProtocol('modemmanager', {
	...
	renderFormOptions: function(s) {
		...
		("none: Do not set an initial EPS bearer (default behaviour)<br/> \
		default: Use the configuration options above (APN, IP Type, ...).<br/> \
		custom: Use different options when establishing a connection (these options are prefixed with an 'init_')."));
		o.value('', _('none'));
