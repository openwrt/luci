...
return view.extend({
  load: function () {
    ...
    render: function() {
      ...
      var key_file = null;
      var ucs = null;
      var uhttpdMap = new form.Map('uhttpd', _('uHTTPd'),
      ...
      var removeOld = ucs.taboption("general", form.Button, "remove_old", _("Remove old certificate and key"),
      ...
      var removeConf = ucs.taboption("general", form.Button, "remove_conf", _("Remove configuration for certificate and key"),
     ...
     var docRoot = ucs.taboption("advanced", form.Value, "home", _("Document root"),
