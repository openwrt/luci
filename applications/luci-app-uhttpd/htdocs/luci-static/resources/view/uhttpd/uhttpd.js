...
return view.extend({
	...
	render: function () {
		...
		csp_mode_option.value('none', _('None (disabled)'), _('Least secure.'));
		csp_mode_option.value('permissive', _('Permissive'), _('More secure. Might be required for some integrations.'));
		csp_mode_option.value('strict', _('Strict'), _('Most secure setting compatible with OpenWRT default settings.'));
