...
lucistatistics_collectddns_ignoresources_desc = 'múltiplos valores, separados por espaço'
...
lucistatistics_collectdirq_ignoreselected = 'Monitorar tudas exceto as selecionadas'
