...
return view.extend({
    ...
    render_sample2_using_jsonmap: function (sample) {
        ...
        */
        m = new form.JSONMap(sample, _('JSONMap TypedSection Sample'), _('See browser console for raw data'));
        ...
        for (var i = option_names.length - 1; i >= 0; i--) {
            ...
            s = m.section(form.TypedSection, option_name, capitalize(display_name), _('Description for this typed section'))
