...
return view.extend({
    ...
    render_sample1_using_array: function (sample) {
        ...
        */
        var table = E('table', { 'class': 'table', 'id': 'approach-1' });
    ...
    */
    ...
    render: function (data) {
        ...
        return E('div', {}, [
            E('div',{'class': 'cbi-section warning'}, _('See browser console for raw data')),
            E('div', { 'class': 'cbi-map', 'id': 'map' }, [
                E('div', { 'class': 'cbi-section', 'id': 'cbi-sample-js' }, [
                    E('div', { 'class': 'left' }, [
                        ...
                        E('div', {}), _("JSON converted to table via array building and loop"),
