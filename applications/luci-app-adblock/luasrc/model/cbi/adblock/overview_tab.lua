...
dv = m:section(NamedSection, "global", "adblock", translate("Runtime Information"))

dv1 = dv:option(DummyValue, "", translate("Adblock Status"))
...
dv2 = dv:option(DummyValue, "", translate("Adblock Version"))
...
dv3 = dv:option(DummyValue, "", translate("Download Utility (SSL Library)"),
...
dv4 = dv:option(DummyValue, "", translate("DNS Backend (DNS Directory)"))
...
dv5 = dv:option(DummyValue, "", translate("Overall Domains"))
...
dv6 = dv:option(DummyValue, "", translate("Last Run"))
