...
function sect(title,kids){
	return E('div',{'class':'cbi-section'},[E('h3',{},title)].concat(kids||[]));
}
...
return view.extend({
	...
	tabConfig:function(ctx){
		...
		ref.appendChild(kvTable(classes.length?classes.map(function(c){return self.clsBoxNode(c);}):[noClassRow()],'qos-cfg-cls'));
		ref.appendChild(E('p',{},
	...
	refreshClasses:function(){
		...
		if(cbox)dom.content(cbox,classes.length?classes.map(function(c){return self.clsBoxNode(c);}):noClassRow());
	},
