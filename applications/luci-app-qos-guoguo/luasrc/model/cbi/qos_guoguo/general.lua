...
ptime = s:option(Value, "pinglimit", translate("Manually control target ping time"),translate("Specify a custom ping time limit here if you want.Leave empty to use the default settings."))
