...
function index()
	...
	entry({"admin","network"}, firstchild(), "VPN", 45).dependent = false
	entry({"admin","network","v2ray_server"},cbi("v2ray_server/index"),_("V2ray Server"),3).dependent=true
	entry({"admin","network","v2ray_server","config"},cbi("v2ray_server/config")).leaf=true
	
	entry({"admin","network","v2ray_server","users_status"},call("v2ray_users_status")).leaf=true
	entry({"admin", "network", "v2ray_server", "check"}, call("v2ray_check")).leaf = true
	entry({"admin", "network", "v2ray_server", "update"}, call("v2ray_update")).leaf = true
end
